...
//#include <Renderer/RenderPass/RenderPassType.h>
//
//namespace Vireo
//{
...
//		{
//			VIR_CORE_ERROR("failed to load model - {0}", import.GetErrorString());
//			return;
//		}
//
...
//			}
//			VIR_ASSERT(boneID != -1, "Bone not found or created..");
//
...
//				VIR_ASSERT(vertexID < (int)mesh->mNumVertices, "Bone data is trying to access an vertex that doesn't exist");
//
...
//					{
//						VIR_CORE_WARN("Hit Bone Vertex Capacity {0} on Vertex id:{1} - Replacing bone:{2} on the vert because it's influence:{3} is less than the bone:{4} we're trying to add's influence:{5}",
...
//					else
//					{
//						VIR_CORE_WARN("Hit Bone Vertex Capacity {0} on Vertex id:{1} - Not adding bone:{2}'s influence amount:{3} because it is the least significant", MaxBonesPerVertex, vertexID, boneID, currentWeight);
//					}
//				}
//			}
//		}
...
//			VIR_CORE_WARN("Mesh's default material contains more than 1 texture for the same type, which isn't currently supported by the standard shaders");
//
